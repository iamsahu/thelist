        ...
        <Grid columns={3} className='equal width center aligned ' stackable style={{marginTop: '2rem'}}> 
            <Grid.Column width={4} >
                ...
                <Card style={{'height':'431px'}} className='ui fluid card'>
                    <Image src={`${process.env.REACT_APP_BASE_URL}/undraw_pitching_36ol_ F5DD47.png`} wrapped ui={false} />
            ...
            <Grid.Column  width={4}>
                ...
                {/* <Card className='ui fluid card'> */}
                    <Image src={`${process.env.REACT_APP_BASE_URL}/undraw_online_connection_6778_ F5DD47.png`} wrapped ui={false} />
